...
class RegisterRequestModel extends RegisterRequest {
  const RegisterRequestModel({required super.name,
...
class UserDataModel extends UserData {
  const UserDataModel({required super.id,
    required super.name,
    required super.email,
...
class HotelImageModel extends HotelImage {
  const HotelImageModel(
      {required super.id, required super.hotelId, required super.image, required super.createdAt, required super.updatedAt});

  factory HotelImageModel.fromJson(Map<String, dynamic> json) {
    return HotelImageModel(id: json["id"],
...
class HotelFacilityModel extends HotelFacility {
  const HotelFacilityModel(
      {required super.id, required super.hotelId, required super.facilityId, required super.createdAt, required super.updatedAt});

  factory HotelFacilityModel.fromJson(Map<String, dynamic> json) {
    return HotelFacilityModel(id: json["id"],
        hotelId: json["hotel_id"],
...
class HotelDetailsModel extends HotelDetails {
  const HotelDetailsModel(
      {required super.id, required super.name, required super.description, required super.price, required super.address, required super.longitude, required super.latitude, required super.rate, required super.createdAt, required super.updatedAt, required super.hotelFacilities, required super.hotelImages});

  factory HotelDetailsModel.fromJson(Map<String, dynamic> json) {
    return HotelDetailsModel(id: json["id"],
        name: json["name"],
        ...
        createdAt: json["created_at"],
        updatedAt: json["updated_at"],
        hotelFacilities: HotelFacilitiesModel.fromJson(json["hotel_facilities"]),
