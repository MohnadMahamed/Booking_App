                            ...
                            children: [
                              ...
                              FadeAnimation(
                                ...
                                child: SmallHeadLineText(
                                    text: LocaleKeys.price_room.tr()),
                              ),
                              SizedBox(
                                height: Dimensions.height20,
                              ),
                              //Price Slider
                              const FadeAnimation(1.3,
                              ...
                              const FadeAnimation(1.6,
                                  child: PopularFacilitiesWidget()),
                              SizedBox(
                                height: Dimensions.height10,
                              ),
                              myDivider(),
                              //name address lat and lon
                              const FadeAnimation(1.9,
                                  child: NameAdressLatAndLonWidget()),
                              myDivider(),
                              //Distance Slider
                              FadeAnimation(
                                2.2,
                              ...
                              const FadeAnimation(2.2,
                                  child: DistanceSliderWidget()),
                              //Divider
                              myDivider(),
                              //count and page
                              const FadeAnimation(2.5,
                                  child: CountAndPageWiget()),
                              const SizedBox(
                                height: 30.0,
                              ),
                            ],
